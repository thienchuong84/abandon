<?php
  ...
  if (isset($_SESSION["id"])) {
    header("Location:mjn_abandon_test_dropdown.php");
  }
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-md-10">
        ...
        <div class="row">
          <!-- use push (left to right) to push colume -->
        ...
        <div class="row">
          ...
          <div class="col-md-6" style="border: 2px solid #999">
            ...
            <form class="form-horizontal" role="form" onsubmit="return js_validateLogin()" method="post" action="">
