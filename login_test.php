<?php
  ...
  /*  Update at Aug 08, 2015 : phần action="" được add <?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?> để query biến php sau đó check dưới đây
  Sau đó viết thêm javascript để check , nếu ok thì thực hiện như điều kiện ở dưới*/
